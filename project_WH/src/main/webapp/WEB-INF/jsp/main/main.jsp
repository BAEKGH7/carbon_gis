...
$( document ).ready(function() {
	...
	var wms = new ol.layer.Tile({
		source : new ol.source.TileWMS({
			url : 'http://localhost:8080/geoserver/baek1/wms?service=WMS&version=1.1.0&request=GetMap&layers=baek1%3Abaek1&bbox=1.386872E7%2C3906626.5%2C1.4680011171788167E7%2C4670269.5&width=768&height=722&srs=EPSG%3A3857&styles=&format=application/openlayers', // 1. 레이어 URL
			params : {
				'VERSION' : '1.1.0', // 2. 버전
